...
select lives_ok(
  $$select public.cms_promote_draft_v2_to_content(
    ...
    '{"schemaVersion":1,"consumerId":"cms.synthetic-article.v1","contentType":"post","title":"QA promoção atômica","blocks":[],"seo":{"title":"QA promoção atômica","description":"Homologação da promoção atômica.","canonicalPath":"/qa-cms-final-promocao-atomica","indexable":false},"provenance":[{"rightsConfirmed":true}]}'::jsonb,
