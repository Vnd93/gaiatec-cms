...
test("rehearsal, canary, workflow and Gate G10 are reproducible but not self-authorizing", async () => {
  const [rehearsal, canary, workflow, gate, plan, policy, localReport] = await Promise.all([
  ...
  assert.match(gate, /G10 PENDENTE/);
