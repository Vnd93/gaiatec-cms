...
| `EV2-E13` | EV2.13 | hardening de release e elegibilidade individual em runtime      | E12         | CI, rehearsal, isolamento, revogação e G13     | manifesto off + funções anteriores      | implementação local; canary pendente          |
