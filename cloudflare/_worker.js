...
const ADMIN_ROUTES =
  /^\/admin(?:\/(login|recuperar-senha|definir-senha|mfa|meu-trabalho|assistente|assistente\/execucao|conteudo(?:\/novo|\/[0-9a-f-]{36})?|produtos(?:\/novo|\/importacao|\/[0-9a-f-]{36})?|descoberta\/(?:service|industry|application|solution)(?:\/[0-9a-f-]{36})?|busca|qualidade|listas-mestras|dados-mestres|pim|paginas(?:\/(?:novo|[0-9a-f-]{36}))?|estudio-visual(?:\/[0-9a-f-]{36})?|sites|site|marketing(?:\/campanhas\/(?:novo|[0-9a-f-]{36})|\/formularios)?|leads|midia|perfil|usuarios|diagnosticos))?\/?$/;
