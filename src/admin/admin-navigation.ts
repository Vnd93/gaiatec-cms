...
export const adminNavigation: AdminNavigationGroup[] = [
  {
    ...
    items: [
      ...
      {
        to: "/admin/assistente/execucao",
        label: "Execução controlada",
        description: "Planeje, aprove, execute e compense comandos apenas sobre alvos sintéticos.",
        icon: ShieldCheck,
        permissions: ["cms:ai.plan", "cms:ai.approve", "cms:ai.execute", "cms:ai.compensate"],
        permissionMode: "any",
        candidate: "ev2.ai_execute",
