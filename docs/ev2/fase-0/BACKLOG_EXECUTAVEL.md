...
| `EV2-E08` | EV2.8  | RBAC escopado, MFA, auditoria e permission evals                | E07         | testes negativos e 100% ações críticas e G8    | revogar grants/flags                    | candidato local; G8 pendente |
| `EV2-E09` | EV2.9  | Estúdio Visual e preparação multisite isolada                   | E08         | bindings, snapshots, tenant escape e G9        | flag; site único permanece              | bloqueado pelo G8            |
