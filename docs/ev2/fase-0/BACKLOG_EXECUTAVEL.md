...
| `EV2-E08` | EV2.8  | RBAC escopado, MFA, auditoria e permission evals                | E07         | testes negativos e 100% ações críticas e G8    | revogar grants/flags                    | liberado para implementação |
