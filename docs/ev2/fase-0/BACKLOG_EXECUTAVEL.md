...
| `EV2-E09` | EV2.9  | Estúdio Visual e preparação multisite isolada                   | E08         | bindings, snapshots, tenant escape e G9        | flag; site único permanece              | validado localmente; G9 pendente |
