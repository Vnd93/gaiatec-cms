          ...
          <AnimateOnScroll>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="relative overflow-hidden" style={{ borderRadius: 4 }}>
                <ResponsiveImage src={INTRO_IMG} alt="Biodigestor GT-BIODIGEST" sizes="(max-width: 1024px) 100vw, 720px" className="w-full h-full object-cover" style={{ aspectRatio: "16/11", display: "block" }} />
          ...
          <AnimateOnScroll delay={0.1}>
            <div className="overflow-x-auto" style={{ borderRadius: 4, border: "1px solid #333" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 800 }}>
                <thead>
                  <tr>
                    <th style={{ backgroundColor: "#0057DE", color: "#ffffff", padding: "14px 16px", fontSize: 13, fontWeight: 700, textAlign: "left", textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "2px solid #e5b800" }}>
                      Especificação
                    </th>
                    {["10.0", "8.0", "5.0", "3.0", "2.0"].map((m) => (
                      <th key={m} style={{ backgroundColor: "#0057DE", color: "#ffffff", padding: "14px 16px", fontSize: 13, fontWeight: 700, textAlign: "center", textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "2px solid #e5b800", borderLeft: "1px solid rgba(0,0,0,0.1)" }}>
                        GT-{m}
                      </th>
                    ))}
                  </tr>
